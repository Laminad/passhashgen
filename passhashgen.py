...
def argument_handler() -> argparse.Namespace:
    ...
    parser.add_argument("-v", dest='verbose', type=int, action="store", default=0, help="Flag to enable or disable whether the status messages print to console other than hash(es) or password(s). The default is not to print status to console 1:Enabled 0:Disabled")
